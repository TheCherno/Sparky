 ...
 *  \ingroup gau_Manager
 */
DLL_EXPORT gau_Manager* gau_manager_create();

/** Creates an audio manager (customizable).
*
*  \ingroup gau_Manager
*/
DLL_EXPORT gau_Manager* gau_manager_create_custom(gc_int32 in_devType,
 ...
 *  \ingroup gau_Manager
 */
DLL_EXPORT void gau_manager_update(gau_Manager* in_mgr);

/** Retrieves the internal mixer object from an audio manager.
 *
 *  \ingroup gau_Manager
 */
DLL_EXPORT ga_Mixer* gau_manager_mixer(gau_Manager* in_mgr);

/** Retrieves the internal buffered stream manager object from an audio manager.
 *
 *  \ingroup gau_Manager
 */
DLL_EXPORT ga_StreamManager* gau_manager_streamManager(gau_Manager* in_mgr);

/** Retrieves the internal device object from an audio manager.
 *
 *  \ingroup gau_Manager
 */
DLL_EXPORT ga_Device* gau_manager_device(gau_Manager* in_mgr);

/** Destroys an audio manager.
 *
 *  \ingroup gau_Manager
 */
DLL_EXPORT void gau_manager_destroy(gau_Manager* in_mgr);
 ...
 */
DLL_EXPORT ga_DataSource* gau_data_source_create_file(const char* in_filename);

/** Creates a data source of bytes from a subregion of a file-on-disk.
 *
 *  \ingroup concreteData
 */
DLL_EXPORT ga_DataSource* gau_data_source_create_file_arc(const char* in_filename, gc_int32 in_offset, gc_int32 in_size);

/** Creates a data source of bytes from a block of shared memory.
 *
 *  \ingroup concreteData
 */
DLL_EXPORT ga_DataSource* gau_data_source_create_memory(ga_Memory* in_memory);
 ...
 */
DLL_EXPORT ga_SampleSource* gau_sample_source_create_wav(ga_DataSource* in_dataSrc);

/** Creates a sample source of PCM samples from an Ogg/Vorbis file.
 *
 *  \ingroup concreteSample
 */
DLL_EXPORT ga_SampleSource* gau_sample_source_create_ogg(ga_DataSource* in_dataSrc);

/** Creates a buffered sample source of PCM samples from another sample source.
 *
 *  \ingroup concreteSample
 */
DLL_EXPORT ga_SampleSource* gau_sample_source_create_buffered(ga_StreamManager* in_mgr, ga_SampleSource* in_sampleSrc, gc_int32 in_bufferSamples);

/** Creates a sample source of PCM samples from a cached sound object.
 *
 *  \ingroup concreteSample
 */
DLL_EXPORT ga_SampleSource* gau_sample_source_create_sound(ga_Sound* in_sound);
 ...
 *  \ingroup loopSample
 */
DLL_EXPORT gau_SampleSourceLoop* gau_sample_source_create_loop(ga_SampleSource* in_sampleSrc);

/** Set loop points on a loop sample source.
 *
 *  \ingroup loopSample
 */
DLL_EXPORT void gau_sample_source_loop_set(gau_SampleSourceLoop* in_sampleSrc, gc_int32 in_triggerSample, gc_int32 in_targetSample);

/** Clear loop points on a loop sample source.
 *
 *  \ingroup loopSample
 */
DLL_EXPORT void gau_sample_source_loop_clear(gau_SampleSourceLoop* in_sampleSrc);

/** Count number of times a loop sample source has looped.
 *
 *  \ingroup loopSample
 */
DLL_EXPORT gc_int32 gau_sample_source_loop_count(gau_SampleSourceLoop* in_sampleSrc);
 ...
 *  \ingroup onFinish
 */
DLL_EXPORT void gau_on_finish_destroy(ga_Handle* in_finishedHandle, void* in_context);
 ...
 *  \ingroup loadHelper
 */
DLL_EXPORT ga_Memory* gau_load_memory_file(const char* in_filename);

/** Load a file's PCM data into a sound object.
 *
 *  \ingroup loadHelper
 */
DLL_EXPORT ga_Sound* gau_load_sound_file(const char* in_filename, const char* in_format);
 ...
 */
DLL_EXPORT ga_Handle* gau_create_handle_memory(ga_Mixer* in_mixer, ga_Memory* in_memory, const char* in_format,
 ...
 *  \ingroup createHelper
 */
DLL_EXPORT ga_Handle* gau_create_handle_sound(ga_Mixer* in_mixer, ga_Sound* in_sound,
                                   ga_FinishCallback in_callback, void* in_context,
                                   gau_SampleSourceLoop** out_loopSrc);
 ...
 *  \ingroup createHelper
 */
DLL_EXPORT ga_Handle* gau_create_handle_buffered_data(ga_Mixer* in_mixer, ga_StreamManager* in_streamMgr,
 ...
 *  \ingroup createHelper
 */
DLL_EXPORT ga_Handle* gau_create_handle_buffered_file(ga_Mixer* in_mixer, ga_StreamManager* in_streamMgr,
