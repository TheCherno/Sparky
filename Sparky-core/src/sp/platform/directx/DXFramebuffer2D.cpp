...
namespace sp { namespace graphics {
	...
	void D3DFramebuffer2D::Init()
	{
		...
		m_Texture = spnew D3DTexture2D(m_Width, m_Height, TextureParameters(), true);
		m_RenderTargetTexture = m_Texture->GetInternalTexture();

		// Setup the description of the render target view.
		renderTargetViewDesc.Format = DXGI_FORMAT_R8G8B8A8_UNORM; // TODO: Retrieve from D3DTexture2D
