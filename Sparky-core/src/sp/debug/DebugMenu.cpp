...
namespace sp { namespace debug {
	...
	void DebugMenu::Add(const String& path, int* value, int minimum, int maximum)
	{
		Add(path, spnew IntAction(path, [value]() { return *value; }, [value](int v) { *value = v; }, minimum, maximum));
	}
