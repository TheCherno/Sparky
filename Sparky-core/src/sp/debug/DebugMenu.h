...
namespace sp { namespace debug {
	...
	public:
		...
		static void Add(const String& path, int* value, int minimum = 0, int maximum = 100);
		static void Add(const String& path, float* value, float minimum = 0.0f, float maximum = 100.0f);
